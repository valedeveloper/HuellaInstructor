...
namespace SistemaAsistencia.CapaVistas
{
    public partial class FrmPersonas : Form
    {
        ...
        private void FrmPersonas_Load(object sender, EventArgs e)
        {
            ...
            dataPersona.Columns[4].Visible = false;
            dataPersona.Columns[5].Visible = false;
            dataPersona.Columns[7].Visible = false;
            dataPersona.Columns[8].Visible = false;
            dataPersona.Columns[9].Visible = false;

            dataPersona.Columns[2].HeaderText ="Nombre" ;
            dataPersona.Columns[3].HeaderText = "Apellido";
            dataPersona.Columns[6].HeaderText = "Funcionario";
